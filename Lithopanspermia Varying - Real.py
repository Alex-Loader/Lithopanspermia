...
PhylaOrderorig=(1,150,34,2,2,3,119,2,1,18,2,1,1,5,17,6,4,3,52,4,1,4,10,2,2,1,1,34,
                2,5,32,6,1,26)
ClassOrderorig=(1,   1,1,2,3,1,1,1,1,1,3,39,15,1,2,3,42,29,4,   8,3,1,2,13,7,   2,   1,1,
                1,2,   16,1,1,3,1,16,22,5,2,1,1,28,1,5,14,1,1,   2,   1,   13,4,1,   2,
                1,   1,   2,2,1,   2,8,7,   2,1,3,   2,1,1,   1,2,   12,1,7,23,1,2,2,4,
                2,2,   1,   2,2,   4,2,3,1,   2,   2,   1,   1,   1,19,9,3,2,   2,   1,3,1,
                12,2,7,1,3,1,1,5,   1,5,   1,   6,14,5,1)
#Total numbers of Classes and Phyla, based off data from www.itis.org
plt.figure()
Phyla_number=34
Class_number=114
PhylaOrder=np.cumsum(PhylaOrderorig)
ClassOrder=np.cumsum(ClassOrderorig)
Order_number=sum(ClassOrderorig)
for i in range(1):
    ...
    repeats=25
    length=np.random.randint(0,21,repeats)
    maxlength=20
    ...
    plt.subplot(3,1,1)
    plt.title("Modern Taxa Distribution compared to Erwin Data",fontsize='18')
    plt.bar(R,Pplot,color=(0.2, 0.4, 0.6, 0.5))
    plt.ylabel("Phyla",fontsize="16")
    plt.subplot(3,1,2)
    plt.bar(R,Cplot,color=(0.2, 0.4, 0.6, 0.5))
    plt.ylabel("Classes",fontsize="16")
    plt.subplot(3,1,3)
    plt.bar(R,Oplot,color=(0.2, 0.4, 0.6, 0.5))
    ...
    plt.subplot(3,1,1)
    #plt.plot(x_phyla_new, y_phyla_new, color=(0,0,0,0.4))
    def func(x, a, b, c):
    ...
    plt.subplot(3,1,2)
    #plt.plot(x_class_new, y_class_new, color=(0,0,0,0.4))
    ...
    plt.subplot(3,1,3)
    #plt.plot(x_order_new, y_order_new, color=(0,0,0,0.4))
...
plt.figure()
plt.subplot(3,1,1)
plt.title("Difference in taxa levels for the Modern Distribution",fontsize='18')
